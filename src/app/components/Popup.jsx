...
const Popup = ({setOpenModal, getDonations,donateCampaign,donate}) => {
  ...
  return (
    <>
    <div className='justify-center items-center flex overflow-x-hidden overflow-y-hidden 
    fixed inset-0 z-50 outline-none focus:outline-none'>
        <div className='relative w-auto my-6 mx-auto max-w-3xl '>
            {/* content */}
            <div className='border-0 rounder-lg shadow-lg relative flex flex-col w-full 
            bg-white outline-none focus:outline-none'>
                ...
                <div className='relative p-6 flex-auto'>
                    ...
                    />
                        {allDonationData?.map((donate,i)=>{
                            return(
                                <p className='my-4 text-slate-500 text-lg leadig-relaxed'>
                                    {i+1}:{donate.donation}{""}
                ...
                border-slate-200 rounded-b'>
                    ...
                    <button className='text-white background active:bg-emarald-600 font-bold
